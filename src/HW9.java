...
public class HW9 {
    ...
    public static void task1() {
            ...
            и бухгалтерия попросила написать программу, в которой можно работать с Ф..О. сотрудников.
    ...
    public static void task2() {
        ...
        String correctFullName = fullName.toUpperCase(Locale.ROOT);
        System.out.println("Данные ФИО сотрудника для заполнения отчета — " + correctFullName);
    }
    public static void task3() {
        ...
        String fullName = "Иванов Иван Семёнович";
        String correctFullName = fullName.replace("ё", "е");
        System.out.println("ФИО сотрудника — " + correctFullName);
    }
