...
public static void task1(){
    ...
    Поэтому каждый раз, когда пользователь заходит на сайт с телефона, мы должны выдавать ему ссылку на
    скачивание приложения. Но мы не знаем, iOS или Android он использует.
    ...
    System.out.println("Если у Вас IOS, введи 0. Если Android - 1" + "\n");
...
банковских карт на дом с четкой датой доставки.
...
- **Критерии оценки**
    ...
    int days;
    Scanner scanner = new Scanner(System.in);
    System.out.println("Введи расстояние доставки");
...
**Критерии оценки**
    ...
    switch (monthNumber) {
        ...
        default: System.out.println("Такого месяца несуществует! Введи корректный номер от 1 до 12!"); break;
    }
